...
| &nbsp;&nbsp; validator.py       | Add custom validators to the `EveServiceValidator` class defined here.                                                                                                                                                                                              |
...
| &nbsp;&nbsp; authorization.py   | Defines `EveServiceAuthorization` which provides authentication to `EveService` .                                                                                                                                                                                   |
